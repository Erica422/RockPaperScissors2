package com.example.excalibur.rockpaperscissors2;
...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView imageViewMe, imageViewCoputer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewCoputer = (ImageView) findViewById(R.id.imageViewComputer);
    ...
    public void setComputerImage(String computer) {
        if(computer.equals("scissors")){
            imageViewCoputer.setImageResource((R.drawable.right_scissors));
        } else if(computer.equals("rock")){
            imageViewCoputer.setImageResource(R.drawable.right_rock);
        }else if(computer.equals("paper")) {
            imageViewCoputer.setImageResource(R.drawable.right_paper);
        }
    }
